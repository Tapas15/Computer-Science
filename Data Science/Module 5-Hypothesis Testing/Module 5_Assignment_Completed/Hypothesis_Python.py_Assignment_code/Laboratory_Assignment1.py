...
lab.apply(lambda x: sum(x.isnull()),axis=0) # checking columns for missing value all clear
...
mod = ols('Laboratory_1~ Laboratory_2+Laboratory_3+Laboratory_4',data = lab).fit()

aov_table=sm.stats.anova_lm(mod, type=2) # anova table made  
